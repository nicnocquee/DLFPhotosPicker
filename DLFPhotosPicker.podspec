#
#  Be sure to run `pod spec lint DLFPhotosPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Nico Prananta"
  # s.authors            = { "Nico Prananta" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Nico Prananta"
  ...
  s.source_files  = "PhotosPicker/Source"
  ...
  s.resource_bundle = {'DLFPhotosPicker' => ['Pod/Assets/*.{lproj,storyboard}']}
